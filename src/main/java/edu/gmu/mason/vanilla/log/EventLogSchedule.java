...
public class EventLogSchedule extends LogSchedule {
	...
	public EventLogSchedule(long startStep, long period, String level, Supplier<EventList> supplier,
	...
	public void step(SimState state) {
		...
		String output;
		if (eventList != null && eventList.update(state.schedule.getSteps()) == UpdateStatus.UPDATED
				&& (output = format.print(eventList)) != null) {

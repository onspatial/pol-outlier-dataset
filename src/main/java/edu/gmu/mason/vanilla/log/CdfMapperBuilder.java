...
public class CdfMapperBuilder {
	// variable1->variable2->
	public static ReflectionValueExtractor functionBuilder(String map, Object instance)
	...
	public static Map<String, ReflectionValueExtractor> functionBuilder(Gson gson, Object instance)
			throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {

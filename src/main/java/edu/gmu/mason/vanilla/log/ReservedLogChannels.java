...
public class ReservedLogChannels implements Serializable {
	...
	private static ConcurrentMap<Level, Setting> init() {
		...
		instance.putIfAbsent(Level.getLevel("INFO"),
				new Setting("pattenrs_of_life", "info level logging", "RollingFile", DEFAULT_DIRECTORY, ".log"));
		...
		if (whatTest != null && whatTest.equals("flexibility")) {
			instance.putIfAbsent(Level.getLevel("MODEL1"),
					new Setting("InstanceVariableTable", "InstanceVariableTable", DEFAULT_OUTPUT_TYPE, "../../"));
			instance.putIfAbsent(Level.getLevel("STAT7"),
					new Setting("SummaryStatisticsDataTable", "SummaryStatisticsDataTable", DEFAULT_OUTPUT_TYPE, ""));

			return instance;
		}
		if (whatTest != null && whatTest.equals("qoi")) {
			instance.putIfAbsent(Level.getLevel("STAT1"),
					new Setting("QOI1Table", "QOI1", DEFAULT_OUTPUT_TYPE, "qois/"));
			instance.putIfAbsent(Level.getLevel("STAT2"),
					new Setting("QOI2Table", "QOI2", DEFAULT_OUTPUT_TYPE, "qois/"));
			instance.putIfAbsent(Level.getLevel("STAT3"),
					new Setting("QOI3Table", "QOI3", DEFAULT_OUTPUT_TYPE, "qois/"));
			instance.putIfAbsent(Level.getLevel("STAT4"),
					new Setting("QOI4Table", "QOI4", DEFAULT_OUTPUT_TYPE, "qois/"));
			instance.putIfAbsent(Level.getLevel("STAT5"),
					new Setting("QOI5Table", "QOI5", DEFAULT_OUTPUT_TYPE, "qois/"));
			instance.putIfAbsent(Level.getLevel("STAT6"),
					new Setting("QOI6Table", "QOI6", DEFAULT_OUTPUT_TYPE, "qois/"));
			return instance;
		}
		...
		if (whatTest != null && whatTest.equals("all")) {
			...
			instance.putIfAbsent(Level.getLevel("ENV8"),
					new Setting("OpenRestaurantState", "OpenRestaurantState", "RollingFile"));
			...
			instance.putIfAbsent(Level.getLevel("AGENT1"),
					new Setting("AgentCharacteristicsTable", "AgentCharacteristics"));
			instance.putIfAbsent(Level.getLevel("AGENT3"), new Setting("JobTable", "Jobs"));
			instance.putIfAbsent(Level.getLevel("AGENT4"),
					new Setting("RelationshipTable", "FriendRelationship", DEFAULT_OUTPUT_TYPE, "qois/"));
			...
			instance.putIfAbsent(Level.getLevel("EVT1"),
					new Setting("TravelJournal", "TravelingJournal", "RollingFile", DEFAULT_DIRECTORY, ".csv"));
			instance.putIfAbsent(Level.getLevel("EVT2"),
					new Setting("FinancialJournal", "FinancialJournal", "RollingFile", DEFAULT_DIRECTORY, ".csv"));
			instance.putIfAbsent(Level.getLevel("EVT3"), new Setting("FinancialAttributesJournal",
					"FinancialAttributesJournal", "RollingFile", DEFAULT_DIRECTORY, ".csv"));
			instance.putIfAbsent(Level.getLevel("EVT4"), new Setting("InterventionJournal", "InterventionJournal",
					"RollingFile", DEFAULT_DIRECTORY, ".csv"));
	...
	protected Object[][] getCandidates() {
		...
		mapper.addMap(cdf.Instance.Run.RunDataTable.VariableName.name, col,
				new SupplierExtractor(
						(Supplier & Serializable) () -> QuantitiesOfInterest.AVERAGE_SOCIAL_NETWORK_DEGREE));

		col = new Column();
		col.index = 2;
		col.name = "Value";
		mapper.addMap(cdf.Instance.Run.RunDataTable.Value.name, col,
				new SupplierExtractor((Supplier & Serializable) () -> model.getQuantitiesOfInterest()
						.getCollectedValues(QuantitiesOfInterest.AVERAGE_SOCIAL_NETWORK_DEGREE).get(getSteps())));
		...
		mapper.addMap(cdf.Instance.Run.RunDataTable.Value.name, col,
				new SupplierExtractor((Supplier & Serializable) () -> model.getQuantitiesOfInterest()
						.getCollectedValues(QuantitiesOfInterest.AVERAGE_BALANCE).get(getSteps())));
		...
		mapper.addMap(cdf.Instance.Run.RunDataTable.VariableName.name, col,
				new SupplierExtractor(
						(Supplier & Serializable) () -> QuantitiesOfInterest.PERCENTAGE_OF_UNHAPPY_AGENTS));
		...
		mapper.addMap(cdf.Instance.Run.RunDataTable.Value.name, col,
				new SupplierExtractor((Supplier & Serializable) () -> model.getQuantitiesOfInterest()
						.getCollectedValues(QuantitiesOfInterest.PERCENTAGE_OF_UNHAPPY_AGENTS).get(getSteps())));
		...
		mapper.addMap(cdf.Instance.Run.RunDataTable.Value.name, col,
				new SupplierExtractor((Supplier & Serializable) () -> model.getQuantitiesOfInterest()
						.getCollectedValues(QuantitiesOfInterest.PUB_VISITS_PER_AGENT).get(getSteps())));
		...
		mapper.addMap(cdf.Instance.Run.RunDataTable.Value.name, col,
				new SupplierExtractor((Supplier & Serializable) () -> model.getQuantitiesOfInterest()
						.getCollectedValues(QuantitiesOfInterest.NUM_OF_SOCIAL_INTERACTIONS).get(getSteps())));
		...
		tableMapper.addMap(schema.CheckinDataset.CheckinTable.CheckinTime.name, col,
				new SupplierExtractor((Supplier & Serializable) () -> model.getSimulationTime()
		...
		col.index = 4;
		col.name = "X";
		tableMapper.addMap(schema.CheckinDataset.CheckinTable.X.name, col,
				(o) -> ((Person) o).getLocation().getGeometry().getCoordinate().x);

		col = new Column();
		col.index = 5;
		col.name = "Y";
		tableMapper.addMap(schema.CheckinDataset.CheckinTable.Y.name, col,
				(o) -> ((Person) o).getLocation().getGeometry().getCoordinate().y);
		...
		OutputFormatter socialNetworkData = new TableFlatFormatterForRelation(
				(Supplier<LocalDateTime> & Serializable) () -> model.getSimulationTime());

		// Keep lambda function safe from serialization
		Object[][] scheduleCandidates = {
				{ "ENV1",
						new LogSchedule(0, "ENV1", (Supplier & Serializable) () -> model.getAllBuildings().get(0),
								new GsonCsvSchemaFormatter(buildingGson), 0) },
				{ "ENV1",
						new IterativeLogSchedule(0, "ENV1",
								(Supplier<Collection> & Serializable) () -> model.getAllBuildings(),
								new GsonCsvValueFormatter(buildingGson), 1) },
				{ "ENV2",
						new LogSchedule(0, "ENV2", (Supplier & Serializable) () -> model.getAllApartments().get(0),
								buildingUnitSchema, 0) },
				{ "ENV2", new IterativeLogSchedule(0, "ENV2",
						(Supplier<Collection> & Serializable) () -> model.getAllApartments(), buildingUnitData, 1) },
				{ "ENV3",
						new LogSchedule(0, "ENV3", (Supplier & Serializable) () -> model.getAllWorkplaces().get(0),
								buildingUnitSchema, 0) },
				{ "ENV3", new IterativeLogSchedule(0, "ENV3",
						(Supplier<Collection> & Serializable) () -> model.getAllWorkplaces(), buildingUnitData, 1) },
				{ "ENV4",
						new LogSchedule(0, "ENV4", (Supplier & Serializable) () -> model.getAllRestaurants().get(0),
								buildingUnitSchema, 0) },
				{ "ENV4", new IterativeLogSchedule(0, "ENV4",
						(Supplier<Collection> & Serializable) () -> model.getAllRestaurants(), buildingUnitData, 1) },
				{ "ENV5",
						new LogSchedule(0, "ENV5", (Supplier & Serializable) () -> model.getAllPubs().get(0),
								buildingUnitSchema, 0) },
				{ "ENV5",
						new IterativeLogSchedule(0, "ENV5",
								(Supplier<Collection> & Serializable) () -> model.getAllPubs(), buildingUnitData, 1) },
				{ "ENV6",
						new LogSchedule(0, "ENV6", (Supplier & Serializable) () -> model.getAllClassrooms().get(0),
								buildingUnitSchema, 0) },
				{ "ENV6", new IterativeLogSchedule(0, "ENV6",
						(Supplier<Collection> & Serializable) () -> model.getAllClassrooms(), buildingUnitData, 1) },
				{ "ENV7",
						new LogSchedule(0, "ENV7", (Supplier & Serializable) () -> model.getUsablePubs().get(0),
								buildingUnitStateSchema, 0) },
				{ "ENV7", new IterativeLogSchedule(0, 1, "ENV7",
						(Supplier<Collection> & Serializable) () -> model.getUsablePubs(), buildingUnitStateData, 1) },
				{ "ENV8",
						new LogSchedule(0, "ENV8", (Supplier & Serializable) () -> model.getUsableRestaurants().get(0),
								buildingUnitStateSchema, 0) },
				{ "ENV8",
						new IterativeLogSchedule(0, 1, "ENV8",
								(Supplier<Collection> & Serializable) () -> model.getUsableRestaurants(),
								buildingUnitStateData, 1) },
				{ "MODEL",
						new LogSchedule(0, "MODEL", (Supplier & Serializable) () -> model.params, characteristicsSchema,
								0) },
				{ "MODEL",
						new LogSchedule(0, "MODEL", (Supplier & Serializable) () -> model.params, characteristicsData,
								1) },
				{ "MODEL1",
						new LogSchedule(0, "MODEL1", (Supplier & Serializable) () -> cdf.Instance.InstanceVariableTable,
								instanceVariableSchema, 0) },
				{ "MODEL1",
						new LogSchedule(0, "MODEL1", (Supplier & Serializable) () -> model.params, instanceVariableData,
								1) },
				{ "AGENT1",
						new LogSchedule(0, "AGENT1", (Supplier & Serializable) () -> model.getAgents().get(0),
								characteristicsSchema, 0) },
				{ "AGENT1", new IterativeLogSchedule(0, "AGENT1",
						(Supplier<Collection> & Serializable) () -> model.getAgents(), characteristicsData, 1) },
				{ "AGENT",
						new LogSchedule(0, "AGENT", (Supplier & Serializable) () -> model.getAgents().get(0),
								stateSchema, 0) },
				{ "AGENT",
						new IterativeLogSchedule(0, 1, "AGENT",
								(Supplier<Collection> & Serializable) () -> model.getAgents(), stateValue, 1) },
				{ "AGENT3",
						new LogSchedule(0, "AGENT3", (Supplier & Serializable) () -> model.getAllJobs().get(0),
								characteristicsSchema, 0) },
				{ "AGENT3", new IterativeLogSchedule(0, "AGENT3",
						(Supplier<Collection> & Serializable) () -> model.getAllJobs(), characteristicsData, 1) },
				// RelationshipDataTable // every one month
				{ "AGENT4", new LogSchedule(0, "AGENT4",
						(Supplier & Serializable) () -> cdf.Instance.Run.RelationshipDataTable, runDataSchema, 0) },
				{ "AGENT4",
						new LogSchedule(0, STEPS_PER_MONTH, "AGENT4",
								(Supplier & Serializable) () -> model.getVisualFriendFamilyGraph(), runData6, 1) },
				{ "STAT", new LogSchedule(0, "STAT", (Supplier & Serializable) () -> censusData, stateSchema, 0) },
				{ "STAT",
						new LogSchedule(0, STEPS_PER_MONTH, "STAT", (Supplier & Serializable) () -> "",
								new CensusDataCollector(), 1) },
				{ "STAT", new IterativeLogSchedule(0, STEPS_PER_MONTH, "STAT",
						(Supplier<Collection> & Serializable) () -> census.getNeighborhoodCensus(), stateValue, 2) },
				{ "STAT1",
						new LogSchedule(0, "STAT1", (Supplier & Serializable) () -> cdf.Instance.Run.RunDataTable,
								runDataSchema, 0) },
				{ "STAT1",
						new LogSchedule(0, STEPS_PER_DAY, "STAT1",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData1, 1) },
				{ "STAT2",
						new LogSchedule(0, "STAT2", (Supplier & Serializable) () -> cdf.Instance.Run.RunDataTable,
								runDataSchema, 0) },
				{ "STAT2",
						new LogSchedule(0, STEPS_PER_DAY, "STAT2",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData2, 1) },
				{ "STAT3",
						new LogSchedule(0, "STAT3", (Supplier & Serializable) () -> cdf.Instance.Run.RunDataTable,
								runDataSchema, 0) },
				{ "STAT3",
						new LogSchedule(0, STEPS_PER_DAY, "STAT3",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData3, 1) },
				{ "STAT4",
						new LogSchedule(0, "STAT4", (Supplier & Serializable) () -> cdf.Instance.Run.RunDataTable,
								runDataSchema, 0) },
				{ "STAT4",
						new LogSchedule(0, STEPS_PER_DAY, "STAT4",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData4, 1) },
				{ "STAT5",
						new LogSchedule(0, "STAT5", (Supplier & Serializable) () -> cdf.Instance.Run.RunDataTable,
								runDataSchema, 0) },
				{ "STAT5",
						new LogSchedule(0, STEPS_PER_DAY, "STAT5",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData5, 1) },
				// for test
				{ "STAT6",
						new LogSchedule(0, "STAT6", (Supplier & Serializable) () -> cdf.Instance.Run.RunDataTable,
								runDataSchema, 0) },
				{ "STAT6",
						new LogSchedule(0, STEPS_PER_DAY, "STAT6",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData1, 1) },
				{ "STAT6",
						new LogSchedule(0, STEPS_PER_DAY, "STAT6",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData2, 1) },
				...
				{ "STAT6",
						new LogSchedule(0, STEPS_PER_DAY, "STAT6",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData5, 1) },
				// EVENT Journal
				{ "EVT10", new LogSchedule(0, "EVT10",
						(Supplier & Serializable) () -> "step\tagentId\t[currentShelter,neighborhood,classroom]",
						textFormatter, 0) },
				{ "EVT10", new IterativeEventLogSchedule(0, 1, "EVT10",
						(Supplier<Collection<EventList>> & Serializable) () -> eventMovingHome, eventFormatter, 1) },
				{ "EVT11",
						new LogSchedule(0, "EVT11", (Supplier & Serializable) () -> "step\tagentId\t[job]",
								textFormatter, 0) },
				{ "EVT11", new IterativeEventLogSchedule(0, 1, "EVT11",
						(Supplier<Collection<EventList>> & Serializable) () -> eventChangingJob, eventFormatter, 1) },
				// For checkin
				{ "AGENT5",
						new LogSchedule(0, "AGENT5", (Supplier & Serializable) () -> schema.CheckinDataset.CheckinTable,
								checkinTableSchema, 0) },
				{ "AGENT5",
						new IterativeLogSchedule(1, 1, "AGENT5",
								(Supplier & Serializable) () -> model.getAgentsCheckin(), checkinData, 1) },
				{ "AGENT6",
						new LogSchedule(0, "AGENT6", (Supplier & Serializable) () -> "time\tfrom\tto", textFormatter,
								0) },
				{ "AGENT6", new LogSchedule(0, STEPS_PER_DAY, "AGENT6",
						(Supplier & Serializable) () -> model.getVisualFriendFamilyGraph(), socialNetworkData, 1) },
		};

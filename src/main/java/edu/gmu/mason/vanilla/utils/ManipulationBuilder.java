...
public class ManipulationBuilder {
	...
	public void appendModel(long step, String accessorExp, String fieldName, Operator op, Object value)
			throws Exception {
	...
	public void appendRoad(long step, String id, String accessorExp, String fieldName, Operator op, Object value)
			throws Exception {
		String[] tokens = accessorExp.split("->");
		List<Accessor> accessors = new ArrayList<Accessor>();
	...
	public void appendPerson(long step, String id, String accessorExp, String fieldName, Operator op, Object value)
			throws Exception {
		String[] tokens = accessorExp.split("->");
		List<Accessor> accessors = new ArrayList<Accessor>();

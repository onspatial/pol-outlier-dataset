...
public class GeoUtils {
	...
	/**
	 * This method is to find the nearest geometry from a given geometry within
	 * distance
	 ...
	 * @return
	 */
	public static MasonGeometry findNearestGeometryWithin(MasonGeometry from, GeomVectorField field,

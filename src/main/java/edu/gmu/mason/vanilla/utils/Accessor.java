							...
							if (types[j].equals(Double.class)) {
								if (parameterTypes[j].equals(Integer.class) || parameterTypes[j].equals(int.class)) {
									numParameters[j] = ((Double) parameters[j])
										...
										|| parameterTypes[j].equals(float.class)) {
									numParameters[j] = ((Double) parameters[j])
											.floatValue();
								} else if (parameterTypes[j].equals(Long.class)
										|| parameterTypes[j].equals(long.class)) {
									numParameters[j] = ((Double) parameters[j])
											.longValue();
								} else if (parameterTypes[j].equals(Short.class)
										|| parameterTypes[j].equals(short.class)) {
									numParameters[j] = ((Double) parameters[j])
											.shortValue();
								} else if (parameterTypes[j].equals(Byte.class)
										|| parameterTypes[j].equals(byte.class)) {
									numParameters[j] = ((Double) parameters[j])
											.byteValue();
								} else if (parameterTypes[j].equals(Double.class)
										|| parameterTypes[j].equals(double.class)) {
									numParameters[j] = ((Double) parameters[j])
											.doubleValue();
								} else {
									assignable = false;

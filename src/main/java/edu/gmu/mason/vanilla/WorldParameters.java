...
public class WorldParameters extends AnnotatedPropertied {
	...
	public static final double BASE_INITIAL_BALANCE = 2000000.0;
	...
	public static final double MINIMUM_HOURLY_RATE = 10000.0;
	public static final double MAXIMUM_HOURLY_RATE = 100000.0;
	...
	private static final int MAXIMUM_FAVORITE_RESTAURANTS = 1;

	private static final int MAXIMUM_FAVORITE_PUBS = 1;
	...
	@Skip
	public int maximumNumberOfFavoriteRestaurants;

	public int maximumNumberOfFavoritePubs;
	...
	protected void initializationWithDefaultValues() {
		...
		maximumNumberOfFavoriteRestaurants = MAXIMUM_FAVORITE_RESTAURANTS;
		maximumNumberOfFavoritePubs = MAXIMUM_FAVORITE_PUBS;
